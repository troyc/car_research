...
No current-generation qualified neutral-forum evidence was found for the requested sparse pairs or long-trip targets after targeted search and source-policy constraints. Future collection should prioritize browser-readable first-person passages that state model years and an explicit comfort-axis winner.
